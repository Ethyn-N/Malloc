...
Implements our own version of malloc and free. Implements a library that interacts with the operating system to perform heap management on behalf of a user process.
